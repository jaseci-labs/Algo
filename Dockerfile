# Algo - Personal AI Assistant
# 
# This Dockerfile builds the Algo application with Jaseci dependencies
...
#
# Run:
#   docker run -p 8000:8000 -e OPENAI_API_KEY=your_key algo:latest
...
# Copy application code first (before cleanup) so jac add --cl works
COPY . .
...
RUN rm -rf /tmp/jaseci/jac-scale /tmp/jaseci/jac-byllm /tmp/jaseci/jac-streamlit \
